...
import MultiSelectDropdown from '../multiselectfooter';
import { CiCircleChevDown, CiCircleChevUp } from 'react-icons/ci';

const Accordion = ({ data, setFilterFooterData }) => {
                  ...
                  <div className="accordion-content">
                    {
                      ...
                      <MultiSelectDropdown index={index} setFilterData={setFilteFooterData} data={data} options={item.options} />
